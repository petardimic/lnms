...
class NodesController extends Controller {
    ...
    static public function mapSnmpSystemToPollClass(Array $snmp_system)
    {
        switch ($snmp_system['sysObjectID']) {
         ...
         case '.1.3.6.1.4.1.9.1.563':
         case '.1.3.6.1.4.1.9.1.564':
         case '.1.3.6.1.4.1.9.1.614':
         case '.1.3.6.1.4.1.9.1.615':
         case '.1.3.6.1.4.1.9.1.617':
         case '.1.3.6.1.4.1.9.1.616':
         case '.1.3.6.1.4.1.9.1.633':
         case '.1.3.6.1.4.1.9.1.634':
         case '.1.3.6.1.4.1.9.1.793':
         case '.1.3.6.1.4.1.9.1.794':
         case '.1.3.6.1.4.1.9.1.795':
         case '.1.3.6.1.4.1.9.1.796':
         case '.1.3.6.1.4.1.9.1.1226':
         case '.1.3.6.1.4.1.9.1.1227':
         case '.1.3.6.1.4.1.9.1.1228':
         case '.1.3.6.1.4.1.9.1.1229':
            return 'Cisco\Cat3560';
            break;

         case '.1.3.6.1.4.1.9.1.108':
         case '.1.3.6.1.4.1.9.1.125':
         case '.1.3.6.1.4.1.9.1.179':
         case '.1.3.6.1.4.1.9.1.194':
         case '.1.3.6.1.4.1.9.1.210':
         case '.1.3.6.1.4.1.9.1.222':
         case '.1.3.6.1.4.1.9.1.223':
         case '.1.3.6.1.4.1.9.1.271':
         case '.1.3.6.1.4.1.9.1.821':
            return 'Cisco\R7200';
            break;

         case '.1.3.6.1.4.1.9.1.325':
         case '.1.3.6.1.4.1.9.1.359':
         case '.1.3.6.1.4.1.9.1.427':
         case '.1.3.6.1.4.1.9.1.428':
         case '.1.3.6.1.4.1.9.1.429':
         case '.1.3.6.1.4.1.9.1.430':
         case '.1.3.6.1.4.1.9.1.472':
         case '.1.3.6.1.4.1.9.1.482':
         case '.1.3.6.1.4.1.9.1.483':
         case '.1.3.6.1.4.1.9.1.484':
         case '.1.3.6.1.4.1.9.1.551':
         case '.1.3.6.1.4.1.9.1.323':
         case '.1.3.6.1.4.1.9.1.324':
         case '.1.3.6.1.4.1.9.1.480':
         case '.1.3.6.1.4.1.9.1.551':
         case '.1.3.6.1.4.1.9.1.560':
            return 'Cisco\Cat2950';
            break;

         case '.1.3.6.1.4.1.9.1.619':
         case '.1.3.6.1.4.1.9.1.576':
         case '.1.3.6.1.4.1.9.1.577':
         case '.1.3.6.1.4.1.9.1.578':
            return 'Cisco\R2800';
            break;
